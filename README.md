...
3. Apply meaningful comment and documentation in code.
4. Using Meaningful and Descriptive names for readability.
5. Error handling
6. Tesing the code in different level like unit testing, subsystem testing and integration testing etc with 100% requirement and code coverage.
    Using Meaningful and Descriptive names for readability.
